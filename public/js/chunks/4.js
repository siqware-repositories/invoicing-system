...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    refreshCard: function refreshCard(card) {
    ...
    submitForm: function submitForm() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result && _this.user.profile) {
          _this.$store.dispatch('storeUser', _this.user).then(function (data) {
            if (data) {
              self.$vs.notify({
                time: 4000,
              ...
              [
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("vs-button", { attrs: { color: "warning" } }, [
                      _vm._v("កែប្រែ")
                    ]),
                    _vm._v(" "),
                    _c(
                          ...
                          "vs-dropdown-item",
                          {
                            on: {
                              click: function($event) {
                                ...
                                _vm.currentItemsPerPage = _vm.totalRecords
                              }
                            }
                          },
